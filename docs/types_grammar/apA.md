...
**提示：** [ES5-Shim](https://github.com/es-shims/es5-shim) 是一个将项目代码桥接至ES5基准线的完整的shims/polyfills集合，相似地，[ES6-Shim](https://github.com/es-shims/es6-shim) 提供了ES6新增的新API的shim。虽然API可以被填补，但新的语法通常是不能的。要桥接语法的部分，你将还需要使用一个ES6到ES5的转译器，比如 [Traceur](https://github.com/google/traceur-compiler/wiki/GettingStarted)。
...
StackOverflow用户“art4theSould”创造性地将这些保留字编成了[一首有趣的小诗](http://stackoverflow.com/questions/26255/reserved-keywords-in-javascript/12114140#12114140)：
